...
class AccountServiceTest {
    ...
    public void getTransactionByAccountNumber_not_found(){
        AccountNotFoundException thrown = Assertions.assertThrows(AccountNotFoundException.class, () -> {
            List<TransactionResponse> testResponse = accountService. getTransactionByAccountNumber("123-2223-214", LocalDateTime.now());
        });
    ...
    public void getTransactionByAccountNumber_found(){
        List<TransactionResponse> testResponse = accountService. getTransactionByAccountNumber("123-2223-213", LocalDateTime.of(2021,11,7,0,0));
